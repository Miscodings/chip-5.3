...
When the listing page is redisplayed with sorting-on-a-column enabled, the column header that was selected for sorting should appear in the drop-down.

The result should look something like this:

![Screenshot showing the "Title" column selected](.guides/img/table-header-screenshot.png)
